				...
				<div class="container-wrap">
					<div class="container main-content">
						<div class="row">
							...
							<div id="explainer" data-midnight="dark" data-top-percent="10%" data-bg-mobile-hidden="" class="wpb_row vc_row-fluid vc_row full-width-section  vc_row-o-equal-height vc_row-flex  vc_row-o-content-middle standard_section   " style="padding-top: calc(100vw * 0.10); padding-bottom: 0px; ">
								<div class="row-bg-wrap">
									<div class="inner-wrap">
										<div class="row-bg    " style=""></div>
									</div>
						...
						<div id="fws_5c3e32c7094dc" data-midnight="dark" data-top-percent="5%" data-bottom-percent="18%" data-bg-mobile-hidden="" class="wpb_row vc_row-fluid vc_row full-width-section standard_section   " style="padding-top: calc(100vw * 0.05); padding-bottom: calc(100vw * 0.18); ">
							<div class="row-bg-wrap">
								<div class="inner-wrap">
									<div class="row-bg    " style=""></div>
								</div>
														...
														<div class="vc_column-inner">
															<div class="wpb_wrapper">
																<div class="nectar-cta " data-style="material" data-alignment="center" data-text-color="custom">
																	<h4>
																		<span class="text">Like what you see? </span>
																		<span class="link_wrap" style="color: #34a853;">
