...
$mensaje= $_POST['mensaje'];
    ...
    //Server settings
	    ...
	    $mail->Subject = 'Te han contactado a través de www.ijbuznego.com';
	    $mail->CharSet ="UTF-8";
      $mail->Body    = '
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="center" style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:40px 20px; background-color: #fff;">
                                	 <img height="24" src="https://ijbuznego.com/images/ijb-logo-02.png" style="height: 120px;"/>
                                	<p style="font-family: Roboto; font-weight: 700; font-size: 30px; color: #000000; margin-top: 5px;margin-bottom: 20px;">SERES</p>
                                    <div style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-bottom:thin solid #dadce0;color:rgba(0,0,0,0.87);line-height:32px;padding-bottom:24px;text-align:center;word-break:break-word">
                                        <div style="font-size:24px">
                                            Te han contactado a través de tu Página Web <a href="http://seres.logotipomiami.com/" style="color: #2a0075;">seres.com</a>
                                        </div>
                                        <table align="center" style="margin-top:8px">
                                            <tbody>
                                                <tr style="line-height:normal">
                                                    <td align="right" style="padding-right:8px">
                                                        <img height="20" src="https://ijbuznego.com/images/ijb-logo-01.png" style="width:20px;height:20px;vertical-align:sub;border-radius:50%;" width="20"/>
                                                    </td>
                                                    <td>
                                    ...
                                    <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px; padding-left: 50px; padding-right: 50px; text-align: justify;">
                                        ...
                                        <p><b>Mensaje:</b> '.$mensaje.'</p>
                                         <div style="padding-top:32px;text-align:center">
                                            <a href="mailto:'.$email.'?subject=Escribe%20el%20asunto%20de%20este%20correo%20aquí&body=Escribe%20tu%20respuesta%20aquí." style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#000;border-radius:5px;min-width:90px" target="_blank" data-saferedirecturl="">
                                                Responder a '.$email.' ➡
                                            </a>
                                        </div>
                                ...
                                <div style="text-align:left">
                                    <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.54);font-size:11px;line-height:18px;padding-top:12px;text-align:center">
                                        <div style="margin-bottom: 15px;">
                                            Has recibido este correo electrónico porque te han escrito a través de tu página de www.ijbuznego.com.
                                        </div>
                                        <div style="direction:ltr">
                                            <a style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.54);font-size:11px;line-height:18px;padding-top:12px;text-align:center">
                                                Copyright &copy; 2019 <br>Todos los derechos reservados por I.J.Buznego | © JakSoluciones C.A
                                            </a>
                                        </div>
                                    </div>
                                </div>
