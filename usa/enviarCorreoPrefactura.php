...
$pname= $_POST['p-name'];
$pcedula= $_POST['p-cedula'];
$pphone= $_POST['p-phone'];
$pemail= $_POST['p-email'];

$fileName = $_FILES['upload-rif']['name'];
$sourcePath = $_FILES['upload-rif']['tmp_name'];
...
move_uploaded_file($sourcePath,$targetPath);
	...
	try {
        ...
        $mail->Username   = 'contacto@jaksoluciones.com';                 // SMTP username
        $mail->Password   = 'r5KW^FHf8+Ej';                           // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port       = 587;                                   // TCP port to connect to

	    //Recipients
        $mail->setFrom('gte.comprasyventas@laramed.net', 'Jak Soluciones');
        $mail->addAddress('gte.comprasyventas@laramed.net', 'Jak Soluciones');     // Add a recipient
        $mail->addReplyTo($email, $name);

	    //Content
	    $mail->isHTML(true);                                  // Set email format to HTML
	    $mail->Subject = 'Te han contactado a través de www.laramed.net - Prefactura';
	    $mail->CharSet ="UTF-8";
    ...
    <tbody>
                                ...
                                <div align="center" style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:40px 20px; background-color: #fff;">
                                    ...
                                    <div style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-bottom:thin solid #dadce0;color:rgba(0,0,0,0.87);line-height:32px;padding-bottom:24px;text-align:center;word-break:break-word">
                                        <div style="font-size:24px">
                                            Te han contactado a través de tu Página Web <a href="https://laramed.net/prefactura.php" style="color: #2a0075;">www.laramed.net/prefactura.php</a>
                                        </div>
                                    </div>
                                    <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:20px; padding-left: 50px; padding-right: 50px; text-align: justify;">
                                        ...
                                        <p><b>Nombre y Apellido/Razon Social:</b> '.$pname.'</p>
                                        <p><b>Cédula:</b> '.$pcedula.'</p>
                                        <p><b>E-mail:</b> '.$pemail.'</p>
                                        <p><b>Nro. Teléfono:</b> '.$pphone.'</p>
                                         <div style="padding-top:32px;text-align:center">
                                            ...
                                            <br>
                                            <a href="mailto:'.$pemail.'?subject=Escribe%20el%20asunto%20de%20este%20correo%20aquí&body=Escribe%20tu%20respuesta%20aquí." style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;line-height:16px;color:#ffffff;font-weight:400;text-decoration:none;font-size:14px;display:inline-block;padding:10px 24px;background-color:#006fab;border-radius:5px;min-width:90px; margin-top: 10px;" target="_blank" data-saferedirecturl="">
                                                Responder a '.$pemail.' ➡
                                            </a>
                                        </div>
                                        <div style="margin: auto; word-break: break-all; overflow-wrap: break-word; word-wrap: break-word; width: 75%;">
                                            ...
                                            <br>
                                            <br>
                                            <a href="mailto:'.$pemail.'?subject=Escribe%20el%20asunto%20de%20este%20correo%20aquí&body=Escribe%20tu%20respuesta%20aquí." style="color: #2a0075;">
                                                mailto:'.$pemail.'?subject=Escribe%20el%20asunto%20de%20este%20correo%20aquí&body=Escribe%20tu%20respuesta%20aquí.
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div style="text-align:left">
                                    <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.54);font-size:11px;line-height:18px;padding-top:12px;text-align:center">
                                        <div style="margin-bottom: 15px;">
                                            Has recibido este correo electrónico porque te han escrito a través de tu página de www.laramed.net/prefactura.php
                                        </div>
      ...
      ';
   $mail->AltBody = $name.' se ha puesto en contacto contigo a través de www.laramed.net:'.$mensaje;
   if($mail->send()){
